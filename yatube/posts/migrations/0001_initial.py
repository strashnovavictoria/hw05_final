# Generated by Django 2.2.16 on 2022-03-12 17:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Введите название поста', max_length=200, verbose_name='Название')),
                ('slug', models.SlugField(help_text='Введите URL поста', max_length=200, unique=True, verbose_name='URL')),
                ('description', models.TextField(help_text='Введите oписание поста', verbose_name='Описание')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
